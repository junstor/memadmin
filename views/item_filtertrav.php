...
?>
                    ...
                    <div id="slabtrav"><?php echo $langs['itemt_travtit'];?><input id="travnum" name="travnum" type="text" /><?php echo $langs['itemt_travtitnum'];?><input id="gotrav" class="but" name="gotrav" type="button" value="<?php echo $langs['itemft_tit'];?>"/></div>
                </div>
            <div id="filtermenu">
            	<div id="keyfilter">
                	<input id="keyfiltercheck" type="checkbox" name="keyfiltercheck" /><label for="keyfiltercheck"><span id="keyfiltertit"><?php echo $langs['itemft_keyfiltertit'];?></span></label><span id="keyfilterinputtit"><?php echo $langs['itemft_filter'];?>：</span><input id="keyfilterin" name="keyfilterin" type="text" />
                </div>
            	<div id="valuefilter">
                	<input id="valuefiltercheck" type="checkbox" name="valuefiltercheck" /><label for="valuefiltercheck"><span id="valuefiltertit"><?php echo $langs['itemft_valuefiltertit'];?></span></label><span id="valuefilterinputtit"><?php echo $langs['itemft_filter'];?>：</span><input id="valuefilterin" name="valuefilterin" type="text" />
                </div>
            </div>
            <div id="filternot">
